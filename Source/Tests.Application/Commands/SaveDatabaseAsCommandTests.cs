...
{
    [TestFixture]
    public class SaveDatabaseAsCommandTests
    {
        private SaveDatabaseAsCommand _command;
        ...
        public void Setup()
        {
            ...
            _command = new SaveDatabaseAsCommand(_view,_viewModel,_databaseRepository);
        }
        ...
        [Test]
        public void AsksUserForNewFileNameAndResultIsBlankCommandWillDoNothing()
        {
        ...
        [Test]
        public void AsksUserForNewFileNameAndResultIsSaveWithNewName()
        {
            ...
            _applicationSettings.Expect(s => s.DatabaseFilePath = databaseFilePath);
